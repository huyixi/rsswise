...
- 新增常量 `COVER_MAX_W`, `COVER_MAX_H`, `COVER_JPEG_Q`, `COVER_TIMEOUT`, `COVER_BRAND_STROKE_WIDTH`, `COVER_BRAND_LETTER_SPACING`, `COVER_DATE_LETTER_SPACING`, `COVER_TITLE_DATE_GAP`, `COVER_IMAGE_GAP`
